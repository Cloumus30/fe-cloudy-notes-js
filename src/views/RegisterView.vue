        ...
        <div class="m-auto w-2/3 md:w-1/3 ">
            ...
            <Form @submit="handleRegister" :validation-schema= validateSchema>
                ...
                <div class="flex justify-around">
                    ...
                    <ButtonLoading :isLoading="isLoading" type="submit" classStr="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-mono rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 disabled:opacity-75"> Daftar </ButtonLoading>
                </div>
